        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" action="<?php echo base_url() ?>product_db" method="POST" enctype="multipart/form-data">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control" name="product_name" id="exampleFirstName" placeholder="Product Name">
                  </div>
                  <div class="col-sm-6 ">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  	 <input type="text" class="form-control" name="unit_in_stock" id="exampleFirstName" placeholder="Units In Stock" min="1">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
